...
export default function ReportsPage() {
  ...
  return (
    <AppShell>
      <AppHeader title="Reports" subtitle="Analytics and reporting" />
      ...
      <main className="flex-1 flex flex-col items-center justify-center bg-cream-canvas p-6 select-none" style={{ paddingTop: '56px' }}>
        <div className="max-w-md w-full bg-white rounded-cards border border-dashed border-stone-border p-8 text-center">
          ...
          <h2 className="font-family-display text-xl text-heading-charcoal tracking-tight mb-2">Analytics & Charts</h2>
          <p className="text-xs text-body-brown leading-relaxed mb-4">
            Visual graphs, conversions metrics, lead channels performance, and pipeline flow diagrams will be plotted right on this dashboard.
          </p>
