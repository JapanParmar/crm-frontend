          ...
          <div className="relative">
            ...
            {profileOpen && (
              <>
                ...
                <div className="fixed right-2 left-2 sm:absolute sm:left-auto sm:right-0 sm:w-56 mt-2 bg-white rounded-cards border border-stone-surface shadow-premium z-40 py-2.5 animate-in fade-in slide-in-from-top-2 duration-150" style={{ top: '56px' }}>
                  ...
                  <div className="py-1">
                    <Link
                      ...
                      className="w-full flex items-center gap-2 px-3.5 py-2.5 hover:bg-stone-surface text-xs text-heading-charcoal font-medium transition-colors"
                    >
                  ...
                  <div className="border-t border-stone-surface pt-1 mt-1">
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3.5 py-2.5 hover:bg-alert-red/5 text-xs text-alert-red font-semibold transition-colors"
                    >
